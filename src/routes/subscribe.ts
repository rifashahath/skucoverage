...
router.post('/', async (c) => {
  ...
  const form = new URLSearchParams({ mode: 'subscription', success_url: 'https://app.skucoverage.com/app/?upgraded=true', cancel_url: 'https://app.skucoverage.com/app/', customer_email: user.email, 'line_items[0][price]': priceId, 'line_items[0][quantity]': '1' });
