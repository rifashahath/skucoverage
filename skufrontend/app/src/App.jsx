 ...
 */
function mapEngineReportToStoreAudit(report, storeDomain, activeAuditId) {
...
export function App() {
  ...
  const handleDownloadReportCsv = async () => {
    ...
    const csvRows = [
      ...
      ['Detected Issues Count', auditData.detectedIssuesCount.toString()],
      ['Critical High Priority', auditData.highPriorityCount.toString()],
      [],
      ['Issue Severity', 'Issue Title', 'Affected Items Count', 'Description'],
